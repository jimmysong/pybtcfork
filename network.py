...
class NetworkEnvelope:
    ...
    def __init__(self, command, payload, magic=NETWORK_MAGIC):
        if len(command) < 12:
    ...
    @classmethod
    async def parse(cls, s, expected_magic):
        ...
        return cls(command, payload, magic)
...
class TxSender:
    ...
    async def connect(self, loop):
        ...
        nonce = int_to_little_endian(1234567890123456789, 8)
        user_agent = b'nobody'
